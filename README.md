"statisticsMU123.py" is the main file that contains the class Dataset used to create objects from datasets, and rounding() function, which was created for precision rounding.
